...
4. The Redirect URL that creates the link between your Cycle Console and Hubspot is shown page where the Client ID and Client Secret are entered.  It has the form
