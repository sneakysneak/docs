...
When integrating with LAUNCH you can have all users make use of the built in account API User (Account LAUNCH) or create & use users in the Cyclr account (User LAUNCH).
